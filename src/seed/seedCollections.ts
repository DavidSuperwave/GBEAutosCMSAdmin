...
const collections: CollectionSeed[] = [
  ...
  },
  {
    name: 'Más vistos',
    slug: 'mas-vistos',
    description: 'Vehículos con mayor demanda reciente.',
    collectionType: 'smart',
    sort: 'mostViewed',
    limit: 12,
    rules: { publishStatus: 'published', inventoryStatus: 'available' },
  ...
  {
    name: 'Inventario Culiacán',
    slug: 'culiacan',
    description: 'Vehículos disponibles en Culiacán.',
    collectionType: 'smart',
    sort: 'newest',
    limit: 12,
    rules: { city: 'Culiacán', publishStatus: 'published', inventoryStatus: 'available' },
  },
  {
    name: 'Destacados editoriales',
    slug: 'destacados',
    description: 'Selección manual para homepage, páginas y campañas.',
