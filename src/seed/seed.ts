    ...
    landing: [
      {
        ...
        items: [
          { label: 'Entrega por agencia', description: 'La unidad se atiende desde Ford Culiacán.' },
...
await payload.updateGlobal({
  ...
  data: {
    ...
    navigation: {
      ...
      cta: { label: 'Contáctanos', href: '/contacts' },
    },
    home: {
      sections: [
        {
          ...
          body: 'Grupo Líder Automotriz en el Noroeste. Más de 90 años de experiencia.',
          primaryLink: { label: 'Ver seminuevos', href: '/seminuevos' },
          secondaryLink: { label: 'Contáctanos', href: '/contacts' },
        },
        { blockType: 'featuredVehicles', heading: 'Vehículos disponibles', limit: 6 },
